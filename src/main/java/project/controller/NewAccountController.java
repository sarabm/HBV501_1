...
public class NewAccountController {
    ...
    /* Instance Variables
    private NewAccountController NewAccountManagementService;

    // Dependency Injection
    @Autowired
    public GetNewAccountsController(NewAccountManagementService NewAccountManagementService) {
        this.NewAccountManagementService = NewAccountManagementService;
    }*/
